...
const ProductionTrafficLight = ({ orders }) => {
    ...
    return (
        <div className="grid grid-cols-3 gap-4 h-full">
            {/* Urgent - Red */}
            <Card glass className="flex flex-col items-center justify-center p-4 bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-900/50">
            ...
            {/* Today - Yellow */}
            <Card glass className="flex flex-col items-center justify-center p-4 bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-900/50">
            ...
            {/* Tomorrow - Green/Blue */}
            <Card glass className="flex flex-col items-center justify-center p-4 bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-900/50">
