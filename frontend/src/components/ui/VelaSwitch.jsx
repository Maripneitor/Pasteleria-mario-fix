...
const VelaSwitch = ({ isChecked, onChange }) => {
    return (
        <StyledWrapper>
            <label className="container">
                <div className="simple-text">Modo Vela</div>
                <input
                    checked={isChecked}
                    onChange={onChange}
                    type="checkbox"
...
const StyledWrapper = styled.div`
  ...
  .container {
    ...
    cursor: pointer;
    user-select: none;
    transform: scale(0.6); /* Scaled down to fit UI */
  }
  ...
  .simple-text {
    ...
    width: 120px;
    text-align: center;
    color: inherit; /* Inherit form parent for better theme integration */
    font-size: 16pt;
    font-weight: 800;
    font-family: monospace;
    display: none; /* Hide text to keep it clean in sidebar */
  }
